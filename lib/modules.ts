...
export const MODULES: ModuleData[] = [
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        module: 1,
        type: 'fill_blank',
        title: 'Fill: Matrix Creation',
        description: 'Complete the code to create a 2x3 matrix of zeros, then change the element at row 1, column 2 to 5.',
        brokenCode: 'A = ___(2, 3);\nA(1, ___) = 5;\ndisp(A)',
        correctCode: 'A = zeros(2, 3);\nA(1, 2) = 5;\ndisp(A)',
        expectedOutput: '     0     5     0\n     0     0     0',
        hints: [
          'What MATLAB function creates a matrix filled with zeros?',
          'The first blank needs the function name. The second blank is the column index.',
          'Use zeros() for the first blank and 2 for the second.',
        ],
        explanation: 'zeros(m,n) creates an m×n matrix of zeros. A(row, col) = value assigns to a specific element.',
        blanks: ['zeros', '2'],
      },
    ],
  },
  ...
  },
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        module: 3,
        type: 'fill_blank',
        title: 'Fill: Matrix Slicing',
        description: 'Complete the code to extract the second row and all columns from matrix A.',
        brokenCode: 'A = [1 2 3; 4 5 6; 7 8 9];\nrow2 = A(___, ___);\ndisp(row2)',
        correctCode: 'A = [1 2 3; 4 5 6; 7 8 9];\nrow2 = A(2, :);\ndisp(row2)',
        expectedOutput: '     4     5     6',
        hints: [
          'The first blank is the row index you want to extract.',
          'The colon : means "all" when used as an index.',
          'A(2, :) extracts row 2, all columns.',
        ],
        explanation: 'A(i, :) extracts all columns from row i. The colon operator means "all elements" in that dimension.',
        blanks: ['2', ':'],
      },
    ],
  },
  ...
  // --- MODULE 6: User I/O ---
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        module: 6,
        type: 'fill_blank',
        title: 'Fill: Formatted Output',
        description: 'Complete the fprintf statement to print "Score: 85 out of 100" using the variables score and total.',
        brokenCode: "score = 85;\ntotal = 100;\nfprintf('Score: ___ out of ___\\n', score, ___)",
        correctCode: "score = 85;\ntotal = 100;\nfprintf('Score: %d out of %d\\n', score, total)",
        expectedOutput: 'Score: 85 out of 100',
        hints: [
          'Use %d to print integers in fprintf.',
          'You need two %d placeholders, one for score and one for total.',
          'The blanks are: %d, %d, total',
        ],
        explanation: 'fprintf uses %d for integers. Each placeholder is replaced by the corresponding argument in order.',
        blanks: ['%d', '%d', 'total'],
      },
    ],
  },
